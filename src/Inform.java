...
public class Inform {
    ...
    public static class Keyword {
        ...
        static final Keyword[] directives = { Abbreviate, Array, Attribute,
                ...
                Style, Switches, Systemfile, Trace, Verb, Zcharacter };
        ...
        static final Keyword[] verbs = { Answer, Ask, AskFor, AskTo, Attack,
                ...
                CommandsRead, Consult, Cut, DefaultUC, Dig, Disrobe, Drink, Drop,
                Eat, Empty, EmptyT, Enter, Examine, Exit, Fill, FullScore,
                GetOff, GiveUC, Go, GoIn, Insert, Inv, JumpUC, JumpOver, Kiss,
                LetGo, Listen, ListMiscellany, LMode1, LMode2, LMode3, Lock,
                Look, LookUnder, Mild, Miscellany, No, NotifyOff, NotifyOn,
                NotUnderstood, Objects, OpenUC, Order, Places, PluralFound, Pray,
                Prompt, Pronouns, Pull, Push, PushDir, PutOn, QuitUC, Receive,
                RemoveUC, Restart, Restore, Rub, SaveUC, ScoreUC, ScriptOff,
                ScriptOn, Search, Set, SetTo, Show, Sing, Sleep, Smell, Sorry,
                Squeeze, Strong, Swim, Swing, SwitchOff, SwitchOn, Take, Taste,
                Tell, TheSame, Think, ThrowAt, ThrownAt, Tie, Touch, Transfer, Turn,
                Unlock, VagueGo, Verify, VersionUC, Wait, Wake, WakeOther, Wave,
                WaveHands, Wear, Yes };
     ...
     * @return <tt>true</tt> if this is an Inform statementkeyword
     */
