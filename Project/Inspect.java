 ...
 */
   public class Inspect {
        ...
        */
        ...
        /**
         * Final position of the Keyword
         */
        public int IpositionEnd;   //posizione finale
         ...
         * @param positionEnd End position of keyword in the Inform document
         */
        public Inspect(String label, int position, int positionEnd) {
            Ilabel=label;
            Iposition = position;
            IpositionEnd = positionEnd;
        }
