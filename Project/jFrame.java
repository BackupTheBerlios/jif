...
public class jFrame extends JFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jFrameImport = new javax.swing.JFrame();
        jPanel5 = new javax.swing.JPanel();
        jScrollPane5 = new javax.swing.JScrollPane();
        jListImportTemplate = new javax.swing.JList();
        jPanel10 = new javax.swing.JPanel();
        jButtonImportSelectAll = new javax.swing.JButton();
        jButtonImportUnselectAll = new javax.swing.JButton();
        jButtonImportFiles = new javax.swing.JButton();
        ...
        jMenuItemFunctionKeys = new javax.swing.JMenuItem();
        ...
        jFrameImport.setTitle(java.util.ResourceBundle.getBundle("JIF").getString("JFRAME_IMPORT_TITLE"));
        jPanel5.setLayout(new java.awt.GridLayout(2, 0));

        jFrameImport.getContentPane().add(jPanel5, java.awt.BorderLayout.NORTH);

        jScrollPane5.setBorder(new javax.swing.border.TitledBorder(java.util.ResourceBundle.getBundle("JIF").getString("JFRAMEIMPORT_LIST_NEW_TEMPLATES")));
        jScrollPane5.setViewportView(jListImportTemplate);

        jFrameImport.getContentPane().add(jScrollPane5, java.awt.BorderLayout.CENTER);

        jButtonImportSelectAll.setText(java.util.ResourceBundle.getBundle("JIF").getString("JFRAME_IMPORT_SELECTALL"));
        jButtonImportSelectAll.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonImportSelectAllActionPerformed(evt);
            }
        });

        jPanel10.add(jButtonImportSelectAll);

        jButtonImportUnselectAll.setText(java.util.ResourceBundle.getBundle("JIF").getString("JFRAME_IMPORT_DESELECTALL"));
        jButtonImportUnselectAll.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonImportUnselectAllActionPerformed(evt);
            }
        });

        jPanel10.add(jButtonImportUnselectAll);

        jButtonImportFiles.setText(java.util.ResourceBundle.getBundle("JIF").getString("JFRAME_IMPORT_IMPORT"));
        jButtonImportFiles.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonImportFilesActionPerformed(evt);
            }
        });

        jPanel10.add(jButtonImportFiles);

        jButtonImportCancel.setText(java.util.ResourceBundle.getBundle("JIF").getString("MESSAGE_CANCEL"));
        ...
        jPanel10.add(jButtonImportCancel);

        jFrameImport.getContentPane().add(jPanel10, java.awt.BorderLayout.SOUTH);
        ...
        jMenuEdit.setMnemonic(java.util.ResourceBundle.getBundle("JIF").getString("MNEMONIC_EDIT").charAt(0));
        ...
        jMenuView.setMnemonic(java.util.ResourceBundle.getBundle("JIF").getString("MNEMONIC_VIEW").charAt(0));
        ...
        jMenuProject.setMnemonic(java.util.ResourceBundle.getBundle("JIF").getString("MNEMONIC_PROJECT").charAt(0));
        ...
        jMenuBuild.setMnemonic(java.util.ResourceBundle.getBundle("JIF").getString("MNEMONIC_BUILD").charAt(0));
        ...
        BuildAll.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_B, java.awt.event.InputEvent.ALT_MASK));
        ...
        Run.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_R, java.awt.event.InputEvent.ALT_MASK));
        ...
        jMenuTemplate.setMnemonic(java.util.ResourceBundle.getBundle("JIF").getString("MNEMONIC_TEMPLATE").charAt(0));
        ...
        jMenuOptions.setMnemonic(java.util.ResourceBundle.getBundle("JIF").getString("MNEMONIC_OPTION").charAt(0));
        ...
        jMenuItemFunctionKeys.setFont(new java.awt.Font("Dialog", 0, 11));
        jMenuItemFunctionKeys.setText(java.util.ResourceBundle.getBundle("JIF").getString("MENUITEM_FUNCTIONKEYS"));
        jMenuItemFunctionKeys.setToolTipText(java.util.ResourceBundle.getBundle("JIF").getString("MENUITEM_FUNCTIONKEYS_TOOLTIP"));
        jMenuItemFunctionKeys.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemFunctionKeysActionPerformed(evt);
            }
        });

        jMenuOptions.add(jMenuItemFunctionKeys);
        ...
        jMenuLinks.setMnemonic(java.util.ResourceBundle.getBundle("JIF").getString("MNEMONIC_LINKS").charAt(0));
...
//        }
    ...
    private void jButtonImportFilesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonImportFilesActionPerformed
        ...
        for (int i=0; i < lenght ;i++){
            // Rescues the parent directory
            directory = ((ImportTemplate)array[i]).Tpath;
            directory = workingDir+"config"+Constants.SEP + directory.substring(0,directory.indexOf(((ImportTemplate)array[i]).Tname));
            File dir = new File(directory);
            if (!dir.exists()){
                // Creates the directory, if don't exist
                dir.mkdirs();
            }
            file = new File(workingDir+"config"+Constants.SEP+ ((ImportTemplate)array[i]).Tpath);
            PrintStream ps;
            try{
                file.createNewFile();
                FileOutputStream fos = new FileOutputStream(file);
                ps = new PrintStream( fos );
                StringTokenizer stok = new StringTokenizer(((ImportTemplate)array[i]).Tcode,"¥");
                while(stok.hasMoreTokens()){
                    ps.println (stok.nextToken()+"\n");
                }
    ...
    private void jButtonImportUnselectAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonImportUnselectAllActionPerformed
        jListImportTemplate.setSelectionInterval(0, 0);
    }//GEN-LAST:event_jButtonImportUnselectAllActionPerformed
    ...
    private void jMenuItemConfigurazioneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemConfigurazioneActionPerformed
        String filename = workingDir+Constants.SEP+"doc"+Constants.SEP+java.util.ResourceBundle.getBundle("JIF").getString("JFRAME_TXT_CONFIGURATION");
    ...
    private void jMenuItemFunctionKeysActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemFunctionKeysActionPerformed
    try{
           loadConfigFiles(workingDir+"config"+Constants.SEP+"functionKeys.ini");
        }
    catch (Exception e){
        System.out.println(e.getMessage());
        System.err.println(e.getMessage());
    }
    }//GEN-LAST:event_jMenuItemFunctionKeysActionPerformed
    ...
    private void jMenuItemHelpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemHelpActionPerformed
        ...
        String filename = workingDir+Constants.SEP+"doc"+Constants.SEP+java.util.ResourceBundle.getBundle("JIF").getString("JFRAME_TXT_INFORMATION");
        File file = new File(filename);
        if (!(file.exists())){
            System.out.println(java.util.ResourceBundle.getBundle("JIF").getString("ERR_OPENFILE1") + filename);
            return;
    ...
    private void jMenuItemCopyrightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemCopyrightActionPerformed
        String filename = workingDir+Constants.SEP+"doc"+Constants.SEP+java.util.ResourceBundle.getBundle("JIF").getString("JFRAME_TXT_COPYRIGHT");
        File file = new File(filename);
        if (!(file.exists())){
            System.out.println(java.util.ResourceBundle.getBundle("JIF").getString("ERR_OPENFILE1") + filename);
            return;
...
//            riga="";
  ...
  private void newAdventure(){
   ...
   private void loadConfig() {
        ...
        // TASTI FUNZIONE
        // apro il file functionsKey.ini e imposto il Vector tastiFunzione
        try{
            String ident,value;
            file = new File(workingDir+"config"+Constants.SEP+"functionKeys.ini");
            if (!(file.exists())){
                System.out.println(java.util.ResourceBundle.getBundle("JIF").getString("ERR_OPENFILE6"));
                return;
            }
            br = new BufferedReader(new FileReader(file));
            tastiFunzione = new Hashtable();
            while ((riga = br.readLine())!=null){
                //salto le di commento che iniziano per Constants.TOKENCOMMENT=#
                if (!(riga.startsWith(Constants.TOKENCOMMENT))&&!(riga.equals(""))){
                    ident   = riga.substring(0,riga.indexOf(','));
                    value = riga.substring(riga.indexOf(',')+1,riga.length());
                    tastiFunzione.put(ident,value);
                }
            }
            br.close();
        } catch(Exception e){
...
//            if (appoggio.indexOf("!")==-1 && appoggio.startsWith("Class")){
    ...
    // inserisce una stringa da un template Manager
    public void insertFromTemplate(String template){
        try{
            //se non ho file aperti, lo segnalo
            if (jTabbedPane1.getTabCount()==0){
                JOptionPane.showMessageDialog(this, java.util.ResourceBundle.getBundle("JIF").getString("STR_JIF22"), java.util.ResourceBundle.getBundle("JIF").getString("STR_JIF23"),  JOptionPane.ERROR_MESSAGE);
                return;
            }
...
//        }
    ...
    public Hashtable getTastiFunzione(){
    ...
    private javax.swing.JList jListImportTemplate;
    ...
    private javax.swing.JMenuItem jMenuItemFunctionKeys;
